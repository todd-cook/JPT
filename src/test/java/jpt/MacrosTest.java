...
public class MacrosTest extends JptTestUtil {
    ...
    public void macroTest () {
        ...
        String trueResult = "<html><head><title>Lovingly Handcrafted Content</title></head><body><table><tr><td colspan=\"2\"><h1>This is our page header</h1></td></tr><tr><td>This is stuff over here on the side:<ul><li>one</li><li>two</li><li>three</li><li>four</li></ul></td><td><p> This extraordinarily interesting content has been lovingly handcrafted by highly qualified content managers.  tsongas is alive and well</p></td></tr></table></body></html>";
    ...
    public void macro2Test () {
        ...
        String trueResult = "<html><head><title>My screed</title></head><body><table><tr><td colspan=\"2\"><h1>This is our page header</h1></td></tr><tr><td>This is stuff over here on the side:<ul><li>one</li><li>two</li><li>three</li><li>four</li></ul></td><td><p>The content for this page goes here.</p></td></tr></table></body></html>";

...
public class StatementsTest extends JptTestUtil {
    ...
    @Test
    public void omit () {
        String templateText = startTag + "<p>This should <span tal:omit-tag=\"\">omit the span tag.</span></p>\n" +
                "<p>This should <span tal:omit-tag=\"here/dumb\">not omit the span tag</span></p>\n" +
                "<p>This should <span tal:omit-tag=\"here/goodLooking\">omit the span tag</span></p>\n" +
                "<p>This should <span tal:omit-tag=\"here/friend/zero\">not omit the span tag</span></p>\n" +
                "<p>This should <span tal:omit-tag=\"here/friend/number\">omit the span tag</span></p>\n" +
                "<p>This is the equivalent of a <span tal:omit-tag=\"\" tal:content=\"here/favoriteColor\">replace</span></p>" + endTag;
        ...
        String trueResult = "<html><p>This should omit the span tag.</p>" +
                "<p>This should <span>not omit the span tag</span></p>" +
                "<p>This should omit the span tag</p>" +
                "<p>This should <span>not omit the span tag</span></p>" +
                "<p>This should omit the span tag</p>" +
                "<p>This is the equivalent of a red</p></html>";
    ...
    public void attributes () {
        ...
        assertTrue (!templateText.equals (result));
        showTransformation (templateText, result);
        String trueResult = "<html><p>This should generate some <span class=\"myclass\" href=\"http://captainsaturn.com/red\">attributes</span></p><p>So should <span html:src=\"55\">this</span></p><p>This should <span enemy=\"clutter\">get rid of my enemy</span></p><p>This should <span noone=\"clutter\">have no attributes</span></p><p>This contains <span how-are-you=\"I am fine; How are you?\" good-looking=\"top model\">a semicolon</span></p><p>A limiting case: <span hello=\";\">semicolon at end</span></p></html>";
        assertTrue (trueResult.equals (removeAllBreaks (result)));
    }
    ...
    public void define () {
        ...
        assertTrue (!templateText.equals (result));
        showTransformation (templateText, result);
        String trueResult = "<html><p><span number=\"99\">my zebra is mc2</span>this is a ';' and this is a '.'</p>" +
                "<p>Do our variables stay in <b>cold storage</b>?</p></html>";
        assertTrue (trueResult.equals (removeAllBreaks (result)));
    }
